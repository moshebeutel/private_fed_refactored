...
from private_federated.models.pFedGP.class_splits import Split, MeanSplitKmeans
from private_federated.models.pFedGP.node import NodepFedGPFull, NodepFedGPIPData, NodepFedGPIPCompute
from private_federated.models.pFedGP.utils import detach_to_numpy, pytorch_take
...
class BinaryTreepFedGPFull(BinaryTree):
    ...
    def _train_tree(self, node, X, Y, to_print=True):
        ...
        batch_classes = set(detach_to_numpy(Y.squeeze()).tolist())

...
from private_federated.models.pFedGP.tree import BinaryTreepFedGPFull, BinaryTreepFedGPIPData, BinaryTreepFedGPIPCompute
from private_federated.models.pFedGP.utils import CE_loss
...
class pFedGPFullLearner(Model):
    ...
    def forward(self, z, y, to_print=False):
